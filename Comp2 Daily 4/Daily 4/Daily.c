...
Date: 2/10
Effort: 25 mins
Purpose: to check, set, and unset flags using bitwise Operators and left and right shift operators
***********************************************************/
...
void unset_flag(unsigned int* flag_holder, int flag_position) {
	int position = 0 << flag_position;


	if (check_flag(*flag_holder, flag_position) == 1) {
		*flag_holder = *flag_holder & position;
